...
<?php
	...
	$proximaSemana = new DateTime('+2 week');
	echo strftime($formatoData2, $proximaSemana->getTimestamp()).'<br>';

	$proximoMes = new DateTime('+2 month');
	echo strftime($formatoData2, $proximoMes->getTimestamp()).'<br>';
